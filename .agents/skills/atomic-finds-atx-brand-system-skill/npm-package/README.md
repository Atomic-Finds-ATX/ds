...
> 📖 **Figma Guide:** See [FIGMA.md](file:///Users/cuus/Claude/projects/atomic-finds-brand/ds/FIGMA.md) for step-by-step instructions on using the Built-in Figma Plugin, Tokens Studio, and Native Variables!
...
│   ├── code.js                 Plugin backend (creates variables, styles & components)
│   └── ui.html                 Plugin branded UI
├── dist/
...
│   ├── tokens/                 CSS token sources
│   ├── components.css          Component styles
│   ├── index.html              living documentation
│   └── assets/                 Logos, fonts, motifs, textures
```
