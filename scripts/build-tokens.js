...
const TOKENS_SRC = path.join(ROOT_DIR, 'design-system', 'tokens', 'canonical-tokens.json');
...
:root {
  ...
  /* --- Elevation / Natural & Colorful Fun Shadows --- */
  --af-shadow-stamp-sm: ${t.shadows.stampSm.css};
  --af-shadow-stamp: ${t.shadows.stamp.css};
  --af-shadow-stamp-lift: ${t.shadows.stampLift.css};
  --af-shadow-pink: ${t.shadows.pink.css};
  --af-shadow-pink-lift: ${t.shadows.pinkLift.css};
  --af-shadow-green: ${t.shadows.green.css};
  --af-shadow-green-lift: ${t.shadows.greenLift.css};
  --af-shadow-yellow: ${t.shadows.yellow.css};
  --af-shadow-yellow-lift: ${t.shadows.yellowLift.css};
  --af-shadow-orange: ${t.shadows.orange.css};
  --af-shadow-orange-lift: ${t.shadows.orangeLift.css};
...
console.log('  ✔ dist/figma-tokens.json');
